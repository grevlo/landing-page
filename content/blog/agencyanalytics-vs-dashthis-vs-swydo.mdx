...
DashThis takes a different approach. Until March 2026 it charged per dashboard rather than per client, which gave it more predictable costs for agencies with complex clients. The interface is fast, the templates are solid, and it has loyal users who have been on the platform for years.

In March 2026, DashThis changed its pricing model to source-based — meaning costs now reflect both the number of dashboards and the data sources you connect. For agencies managing multiple clients across multiple channels, this change significantly altered the cost calculation.

The fundamental limitation of DashThis has always been the same as AgencyAnalytics: it is a marketing data visualisation tool. It pulls from Google Analytics, Meta Ads, Google Ads. It does not monitor whether your client's site is actually up. It does not check SSL certificate expiry. For web agencies managing hosting and technical health alongside marketing performance, you are assembling a reporting picture from multiple tools.

**Honest summary:** Well-executed dashboard tool for marketing data. Pricing model changed in 2026 making costs harder to predict. Still no native web infrastructure monitoring.
...
| DashThis | Variable (source-based, 2026) | No | Dashboard |
| **Grevlo** | **£99/month** | **Yes** | **Headless API** |
...
The pricing is £99/month flat. No per-client fees. No per-source charges. Whether you have 3 retainer clients or 50, the cost is the same.
...
We're currently running a founding partner programme for UK agencies. Five spots, three months free, in exchange for honest feedback and a backlink. If you continue after the trial, the rate is permanently locked at £99/month regardless of future price changes.
